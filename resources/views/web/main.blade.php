...
<html>
    ...
    <body>
        ...
        <header id="header">
            <div class="language">
                <a href="{{ $my_data['current_url']['en']}}" <?php echo ($my_data['web_language'] == 'en')?' class="current"':'';?>>EN</a>
                <a href="{{ $my_data['current_url']['zh-hk']}}"<?php echo ($my_data['web_language'] == 'zh-hk')?' class="current"':'';?>>繁</a>
            </div>
        </header>
        @endif
