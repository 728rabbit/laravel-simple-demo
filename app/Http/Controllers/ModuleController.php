...
class ModuleController extends Controller {
    ...
    public function __construct() {
        ...
        app()->setLocale((strtolower($this->_my_route_data['module']) == 'wportal')?$this->_my_route_data['web_language']:$this->_my_route_data['cportal_language']);
 
        // call middleware if need
        $find_middleware = implode('.',[
            strtolower($this->_my_route_data['module']),
            strtolower($this->_my_route_data['class']),
            strtolower($this->_my_route_data['function'])
        ]);
