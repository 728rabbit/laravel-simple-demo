...
class PageController extends Controller {
    ...
    public function __construct($data) {
        ...
        app()->setLocale(($this->_my_data['module'] == 'wportal')?$this->_my_data['wportal_language']:$this->_my_data['cportal_language']);
    ...
    protected function renderView($view_name = '', $extra_data = []) {
        ...
        if(!empty($view_name) && View::exists($this->_my_data['module'].'.'.$view_name)) {
            // try to load default css & js file
            if(file_exists('../resources/css/'.$this->_my_data['module'].'/common.css')) {
                $this->_css_files[] = '../resources/css/'.$this->_my_data['module'].'/common.css';
            }
            if(file_exists('../resources/css/'.$this->_my_data['module'].'/'.$this->_my_data['class'].'.css')) {
                $this->_css_files[] = '../resources/css/'.$this->_my_data['module'].'/'.$this->_my_data['class'].'.css';
            }
            if(file_exists('../resources/js/'.$this->_my_data['module'].'/'.$this->_my_data['class'].'.js')) {
                $this->_js_files[] = '../resources/js/'.$this->_my_data['module'].'/'.$this->_my_data['class'].'.js';
            }
